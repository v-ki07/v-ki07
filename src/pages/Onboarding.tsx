...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-zinc-950 flex items-center justify-center p-4 transition-colors duration-500">
      ...
      <Card className="w-full max-w-lg relative z-10 border-none shadow-2xl overflow-hidden dark:bg-zinc-900">
        <CardContent className="p-0">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-gray-500 dark:text-zinc-400 text-lg leading-relaxed mb-12">
              ...
              <div className="flex flex-col gap-6">
                <Button 
                  onClick={nextStep}
                  className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-8 rounded-2xl text-lg shadow-lg shadow-indigo-100 dark:shadow-none transition-all hover:scale-[1.02]"
                >
                  ...
                  {steps.map((_, i) => (
                    <div 
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${
                        i === currentStep ? "w-8 bg-indigo-600" : "w-2 bg-gray-200 dark:bg-zinc-800"
                      }`}
                    />
                  ))}
                </div>
