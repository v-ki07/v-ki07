...
import { Sparkles, Brain, TrendingUp, ArrowRight, Heart } from "lucide-react";
...
const steps = [
  ...
  },
  {
    ...
    description: "Track patterns in your mood to better understand what influences your well-being.",
    icon: <Brain className="w-12 h-12 text-indigo-500" />,
    color: "bg-indigo-50",
  },
  {
    title: "Visualize Progress",
    description: "See your emotional journey over time with beautiful, easy-to-read charts.",
